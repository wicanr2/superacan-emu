...
var translations = []translation{
	...
	{"AboutLicense", [5]string{"RRSAL-1.0 (source-available). Free for non-commercial use; commercial use needs written permission. Full text: LICENSE in the repository.", "RRSAL-1.0 (source-available). Usage non commercial gratuit ; l'usage commercial requiert une autorisation écrite. Texte complet : LICENSE dans le dépôt.", "RRSAL-1.0 (source-available). Uso no comercial gratuito; el uso comercial requiere permiso por escrito. Texto completo: LICENSE en el repositorio.", "RRSAL-1.0（source-available）。非商業用途免費，商業使用需事先書面授權。全文見儲存庫的 LICENSE。", "RRSAL-1.0（source-available）。非商业用途免费，商业使用需事先书面授权。全文见存储库的 LICENSE。"}},
